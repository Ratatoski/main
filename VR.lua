...
HVR["1"] = Instance.new("ScreenGui", game:GetService("Players").LocalPlayer:WaitForChild("PlayerGui"));
HVR["1"]["ZIndexBehavior"] = Enum.ZIndexBehavior.Sibling;

HVR["2"] = Instance.new("Frame", HVR["1"]);
HVR["2"]["BorderSizePixel"] = 0;
HVR["2"]["BackgroundColor3"] = Color3.fromRGB(0, 0, 0);
HVR["2"]["Size"] = UDim2.new(0, 50, 0, 50);
HVR["2"]["Draggable"] = true
HVR["2"]["Position"] = UDim2.new(0.20, 0, -0.1, 0);
HVR["2"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);


HVR["3"] = Instance.new("UICorner", HVR["2"]);
HVR["3"]["CornerRadius"] = UDim.new(1, 0);

HVR["4"] = Instance.new("TextButton", HVR["2"]);
HVR["4"]["TextWrapped"] = true;
HVR["4"]["BorderSizePixel"] = 0;
HVR["4"]["TextSize"] = 14;
HVR["4"]["TextColor3"] = Color3.fromRGB(255, 255, 255);
HVR["4"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
HVR["4"]["FontFace"] = Font.new([[rbxasset://fonts/families/SourceSansPro.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal);
HVR["4"]["Size"] = UDim2.new(0, 50, 0, 56);
HVR["4"]["BackgroundTransparency"] = 1;
HVR["4"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
HVR["4"]["Text"] = [[STOP TWEEN]];
HVR["4"]["Position"] = UDim2.new(0, 0, -0.07273, 0);
HVR["5"] = Instance.new("UIStroke", HVR["4"]);
HVR["5"]["Color"] = Color3.fromRGB(255, 0, 0);

HVR["6"] = Instance.new("UIStroke", HVR["2"]);
HVR["6"]["Color"] = Color3.fromRGB(169, 238, 8);
...
HVR["4"].MouseButton1Click:Connect(function()
    StopTween()
end)
...
Discord.MouseButton1Click:Connect(function()
    (setclipboard or toclipboard)("https://discord.gg/NE3TtgXHs6")
    wait(.1)
